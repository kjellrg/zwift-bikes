...
const props = defineProps<{
   ...
   * see `ogElevationProfile` in `pages/routes/[slug].vue`.
   */
  profile?: number[]
}>()
...
<template>
  <div
    ...
    style="background: linear-gradient(160deg, #0b1220 0%, #030712 100%); padding: 56px 64px; position: relative;"
  >
    <img
      v-if="profileImage"
      :src="profileImage"
    ...
    <div
      ...
      style="gap: 8px;"
    >
      <span style="font-size: 22px; font-weight: 700; color: #94a3b8; letter-spacing: 3px;">FASTEST SETUP</span>
